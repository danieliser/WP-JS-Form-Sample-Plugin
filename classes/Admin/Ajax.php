...
class Ajax {
	...
	public static function init() {
		add_action( 'wp_ajax_wpjsfsp_object_search', array( __CLASS__, 'object_search' ) );
		add_action( 'wp_ajax_wpjsfsp_options_autosave', array( __CLASS__, 'options_autosave' ) );
	}
	...
	public static function options_autosave() {
		...
		if( wp_verify_nonce( $nonce, 'wpjsfsp-admin-nonce' ) && isset( $option_value ) ) {
