...
(function (factory) {
    ...
    var S2 =
            (function () {
                ...
                if (jQuery && jQuery.fn && jQuery.fn.wpjsfselect2 && jQuery.fn.wpjsfselect2.amd) {
                    var S2 = jQuery.fn.wpjsfselect2.amd;
                }
                var S2;
                (function () {
                    if (!S2 || !S2.requirejs) {
...
//be followed.
                ...
                S2.define('wpjsfselect2/results', [
                    'jquery',
                    './utils'
                ], function ($, Utils) {
                    ...
                    Results.prototype.render = function () {
                        var $results = $(
                            '<ul class="wpjsfselect2-results__options" role="tree"></ul>'
                        );
                    ...
                    Results.prototype.displayMessage = function (params) {
                        ...
                        var $message = $(
                            ...
                            ' class="wpjsfselect2-results__option"></li>'
                        );
                        ...
                        $message[0].className += ' wpjsfselect2-results__message';

                        this.$results.append($message);
                    };

                    Results.prototype.hideMessages = function () {
                        this.$results.find('.wpjsfselect2-results__message').remove();
                    };
                    ...
                    Results.prototype.position = function ($results, $dropdown) {
                        var $resultsContainer = $dropdown.find('.wpjsfselect2-results');
                    ...
                    Results.prototype.setClasses = function () {
                        ...
                        this.data.current(function (selected) {
                            ...
                            var $options = self.$results
                                .find('.wpjsfselect2-results__option[aria-selected]');
                    ...
                    Results.prototype.option = function (data) {
                        ...
                        option.className = 'wpjsfselect2-results__option';
                        ...
                        if (data.children) {
                            ...
                            label.className = 'wpjsfselect2-results__group';
                            ...
                            var $childrenContainer = $('<ul></ul>', {
                                'class': 'wpjsfselect2-results__options wpjsfselect2-results__options--nested'
                            });
                    ...
                    Results.prototype.bind = function (container, $container) {
                        ...
                        container.on('results:focus', function (params) {
                            params.element.addClass('wpjsfselect2-results__option--highlighted');
                        });
                        ...
                        this.$results.on('mouseup', '.wpjsfselect2-results__option[aria-selected]',
                            function (evt) {
                                var $this = $(this);
                        ...
                        this.$results.on('mouseenter', '.wpjsfselect2-results__option[aria-selected]',
                            function (evt) {
                                var data = $(this).data('data');

                                self.getHighlightedResults()
                                    .removeClass('wpjsfselect2-results__option--highlighted');
                    ...
                    Results.prototype.getHighlightedResults = function () {
                        var $highlighted = this.$results
                            .find('.wpjsfselect2-results__option--highlighted');
                ...
                S2.define('wpjsfselect2/keys', [], function () {
                    var KEYS = {
                        BACKSPACE: 8,
                        TAB: 9,
                        ENTER: 13,
                ...
                S2.define('wpjsfselect2/selection/base', [
                    'jquery',
                    '../utils',
                    '../keys'
                ], function ($, Utils, KEYS) {
                    ...
                    BaseSelection.prototype.render = function () {
                        var $selection = $(
                            '<span class="wpjsfselect2-selection" role="combobox" ' +
                    ...
                    BaseSelection.prototype._attachCloseHandler = function (container) {
                        ...
                        $(document.body).on('mousedown.wpjsfselect2.' + container.id, function (e) {
                            var $target = $(e.target);

                            var $select = $target.closest('.wpjsfselect2');

                            var $all = $('.wpjsfselect2.wpjsfselect2-container--open');
                            ...
                            $all.each(function () {
                                ...
                                $element.wpjsfselect2('close');
                            });
                        });
                    };

                    BaseSelection.prototype._detachCloseHandler = function (container) {
                        $(document.body).off('mousedown.wpjsfselect2.' + container.id);
                    };
                ...
                S2.define('wpjsfselect2/selection/single', [
                    'jquery',
                    './base',
                    '../utils',
                    '../keys'
                    ...
                    SingleSelection.prototype.render = function () {
                        ...
                        $selection.addClass('wpjsfselect2-selection--single');

                        $selection.html(
                            '<span class="wpjsfselect2-selection__rendered"></span>' +
                            '<span class="wpjsfselect2-selection__arrow" role="presentation">' +
                    ...
                    SingleSelection.prototype.bind = function (container, $container) {
                        ...
                        this.$selection.find('.wpjsfselect2-selection__rendered').attr('id', id);
                    ...
                    SingleSelection.prototype.clear = function () {
                        this.$selection.find('.wpjsfselect2-selection__rendered').empty();
                    };
                    ...
                    SingleSelection.prototype.update = function (data) {
                        ...
                        var $rendered = this.$selection.find('.wpjsfselect2-selection__rendered');
                ...
                S2.define('wpjsfselect2/selection/multiple', [
                    'jquery',
                    './base',
                    '../utils'
                    ...
                    MultipleSelection.prototype.render = function () {
                        ...
                        $selection.addClass('wpjsfselect2-selection--multiple');

                        $selection.html(
                            '<ul class="wpjsfselect2-selection__rendered"></ul>'
                        );
                    ...
                    MultipleSelection.prototype.bind = function (container, $container) {
                        ...
                        this.$selection.on(
                            'click',
                            '.wpjsfselect2-selection__choice__remove',
                            function (evt) {
                    ...
                    MultipleSelection.prototype.selectionContainer = function () {
                        var $container = $(
                            '<li class="wpjsfselect2-selection__choice">' +
                            '<span class="wpjsfselect2-selection__choice__remove" role="presentation">' +
                            '&times;' +
                            '</span>' +
                            '</li>'
                        );
                ...
                S2.define('wpjsfselect2/selection/placeholder', [
                    '../utils'
                ], function (Utils) {
                    ...
                    Placeholder.prototype.createPlaceholder = function (decorated, placeholder) {
                        ...
                        $placeholder.addClass('wpjsfselect2-selection__placeholder')
                            .removeClass('wpjsfselect2-selection__choice');
                    ...
                    Placeholder.prototype.update = function (decorated, data) {
                        ...
                        this.$selection.find('.wpjsfselect2-selection__rendered').append($placeholder);
                    };

                    return Placeholder;
                });

                S2.define('wpjsfselect2/selection/allowClear', [
                    'jquery',
                    '../keys'
                ], function ($, KEYS) {
                    function AllowClear() {
                    ...
                    AllowClear.prototype.bind = function (decorated, container, $container) {
                        ...
                        this.$selection.on('mousedown', '.wpjsfselect2-selection__clear',
                            function (evt) {
                    ...
                    AllowClear.prototype._handleClear = function (_, evt) {
                        ...
                        var $clear = this.$selection.find('.wpjsfselect2-selection__clear');
                    ...
                    AllowClear.prototype.update = function (decorated, data) {
                        ...
                        if (this.$selection.find('.wpjsfselect2-selection__placeholder').length > 0 ||
                            data.length === 0) {
                            return;
                        }

                        var $remove = $(
                            '<span class="wpjsfselect2-selection__clear">' +
                            '&times;' +
                            '</span>'
                        );
                        $remove.data('data', data);

                        this.$selection.find('.wpjsfselect2-selection__rendered').prepend($remove);
                    };

                    return AllowClear;
                });

                S2.define('wpjsfselect2/selection/search', [
                    'jquery',
                    '../utils',
                    '../keys'
                ], function ($, Utils, KEYS) {
                    ...
                    Search.prototype.render = function (decorated) {
                        var $search = $(
                            '<li class="wpjsfselect2-search wpjsfselect2-search--inline">' +
                            '<input class="wpjsfselect2-search__field" type="search" tabindex="-1"' +
                    ...
                    Search.prototype.bind = function (decorated, container, $container) {
                        ...
                        this.$selection.on('focusin', '.wpjsfselect2-search--inline', function (evt) {
                            self.trigger('focus', evt);
                        });

                        this.$selection.on('focusout', '.wpjsfselect2-search--inline', function (evt) {
                            self._handleBlur(evt);
                        });

                        this.$selection.on('keydown', '.wpjsfselect2-search--inline', function (evt) {
                            evt.stopPropagation();
                            ...
                            if (key === KEYS.BACKSPACE && self.$search.val() === '') {
                                var $previousChoice = self.$searchContainer
                                    .prev('.wpjsfselect2-selection__choice');
                    ...
                    Search.prototype.update = function (decorated, data) {
                        ...
                        this.$selection.find('.wpjsfselect2-selection__rendered')
                    ...
                    Search.prototype.resizeSearch = function () {
                        ...
                        if (this.$search.attr('placeholder') !== '') {
                            width = this.$selection.find('.wpjsfselect2-selection__rendered').innerWidth();
                        } else {
                ...
                S2.define('wpjsfselect2/selection/eventRelay', [
                    'jquery'
                ], function ($) {
                    function EventRelay() {
                    }
                    ...
                    EventRelay.prototype.bind = function (decorated, container, $container) {
                        ...
                        container.on('*', function (name, params) {
                            ...
                            var evt = $.Event('wpjsfselect2:' + name, {
                                params: params
                            });
                ...
                S2.define('wpjsfselect2/translation', [
                    'jquery',
                    'require'
                ], function ($, require) {
                ...
                S2.define('wpjsfselect2/diacritics', [], function () {
                    var diacritics = {
                        '\u24B6': 'A',
                        '\uFF21': 'A',
                        '\u00C0': 'A',
                ...
                S2.define('wpjsfselect2/data/base', [
                    '../utils'
                ], function (Utils) {
                ...
                S2.define('wpjsfselect2/data/select', [
                    './base',
                    '../utils',
                    'jquery'
                ...
                S2.define('wpjsfselect2/data/array', [
                    './select',
                    '../utils',
                    'jquery'
                ...
                S2.define('wpjsfselect2/data/ajax', [
                    './array',
                    '../utils',
                    'jquery'
                ...
                S2.define('wpjsfselect2/data/tags', [
                    'jquery'
                ], function ($) {
                    ...
                    Tags.prototype.query = function (decorated, params, callback) {
                        ...
                        function wrapper(obj, child) {
                            ...
                            if (tag != null) {
                                ...
                                $option.attr('data-wpjsfselect2-tag', true);
                    ...
                    Tags.prototype._removeOldTags = function (_) {
                        ...
                        var $options = this.$element.find('option[data-wpjsfselect2-tag]');
                ...
                S2.define('wpjsfselect2/data/tokenizer', [
                    'jquery'
                ], function ($) {
                    ...
                    Tokenizer.prototype.bind = function (decorated, container, $container) {
                        ...
                        this.$search = container.dropdown.$search || container.selection.$search ||
                            $container.find('.wpjsfselect2-search__field');
                    };
                ...
                S2.define('wpjsfselect2/data/minimumInputLength', [], function () {
                ...
                S2.define('wpjsfselect2/data/maximumInputLength', [], function () {
                ...
                S2.define('wpjsfselect2/data/maximumSelectionLength', [], function () {
                ...
                S2.define('wpjsfselect2/dropdown', [
                    'jquery',
                    './utils'
                ], function ($, Utils) {
                    ...
                    Dropdown.prototype.render = function () {
                        var $dropdown = $(
                            '<span class="wpjsfselect2-dropdown">' +
                            '<span class="wpjsfselect2-results"></span>' +
                            '</span>'
                        );
                ...
                S2.define('wpjsfselect2/dropdown/search', [
                    'jquery',
                    '../utils'
                ], function ($, Utils) {
                    function Search() {
                    ...
                    Search.prototype.render = function (decorated) {
                        ...
                        var $search = $(
                            '<span class="wpjsfselect2-search wpjsfselect2-search--dropdown">' +
                            '<input class="wpjsfselect2-search__field" type="search" tabindex="-1"' +
                            ' autocomplete="off" autocorrect="off" autocapitalize="off"' +
                    ...
                    Search.prototype.bind = function (decorated, container, $container) {
                        ...
                        container.on('results:all', function (params) {
                            if (params.query.term == null || params.query.term === '') {
                                ...
                                if (showSearch) {
                                    self.$searchContainer.removeClass('wpjsfselect2-search--hide');
                                } else {
                                    self.$searchContainer.addClass('wpjsfselect2-search--hide');
                                }
                            }
                        });
                    };
                ...
                S2.define('wpjsfselect2/dropdown/hidePlaceholder', [], function () {
                ...
                S2.define('wpjsfselect2/dropdown/infiniteScroll', [
                    'jquery'
                ], function ($) {
                    ...
                    InfiniteScroll.prototype.createLoadingMore = function () {
                        var $option = $(
                            '<li ' +
                            'class="wpjsfselect2-results__option wpjsfselect2-results__option--load-more"' +
                ...
                S2.define('wpjsfselect2/dropdown/attachBody', [
                    'jquery',
                    '../utils'
                ], function ($, Utils) {
                    ...
                    AttachBody.prototype.position = function (decorated, $dropdown, $container) {
                        ...
                        $dropdown.removeClass('wpjsfselect2');
                        $dropdown.addClass('wpjsfselect2-container--open');
                    ...
                    AttachBody.prototype._attachPositioningHandler =
                        function (decorated, container) {
                            ...
                            var scrollEvent = 'scroll.wpjsfselect2.' + container.id;
                            var resizeEvent = 'resize.wpjsfselect2.' + container.id;
                            var orientationEvent = 'orientationchange.wpjsfselect2.' + container.id;

                            var $watchers = this.$container.parents().filter(Utils.hasScroll);
                            $watchers.each(function () {
                                $(this).data('wpjsfselect2-scroll-position', {
                                    x: $(this).scrollLeft(),
                                    y: $(this).scrollTop()
                                });
                            });
                            ...
                            $watchers.on(scrollEvent, function (ev) {
                                var position = $(this).data('wpjsfselect2-scroll-position');
                    ...
                    AttachBody.prototype._positionDropdown = function () {
                        ...
                        var isCurrentlyAbove = this.$dropdown.hasClass('wpjsfselect2-dropdown--above');
                        var isCurrentlyBelow = this.$dropdown.hasClass('wpjsfselect2-dropdown--below');
                        ...
                        if (newDirection != null) {
                            this.$dropdown
                                .removeClass('wpjsfselect2-dropdown--below wpjsfselect2-dropdown--above')
                                .addClass('wpjsfselect2-dropdown--' + newDirection);
                            this.$container
                                .removeClass('wpjsfselect2-container--below wpjsfselect2-container--above')
                                .addClass('wpjsfselect2-container--' + newDirection);
                        }
                ...
                S2.define('wpjsfselect2/dropdown/minimumResultsForSearch', [], function () {
                ...
                S2.define('wpjsfselect2/dropdown/selectOnClose', [], function () {
                ...
                S2.define('wpjsfselect2/dropdown/closeOnSelect', [], function () {
                ...
                S2.define('wpjsfselect2/i18n/en', [], function () {
                    // English
                    return {
                ...
                S2.define('wpjsfselect2/defaults', [
                    'jquery',
                    'require',
                ...
                S2.define('wpjsfselect2/options', [
                    'require',
                    'jquery',
                    './defaults',
                    './utils'
                    ...
                    Options.prototype.fromElement = function ($e) {
                        ...
                        if ($e.data('wpjsfselect2Tags')) {
                            if (this.options.debug && window.console && console.warn) {
                                console.warn(
                                    'Select2: The `data-wpjsfselect2-tags` attribute has been changed to ' +
                                    'use the `data-data` and `data-tags="true"` attributes and will be ' +
                                    'removed in future versions of Select2.'
                                );
                            }

                            $e.data('data', $e.data('wpjsfselect2Tags'));
                            $e.data('tags', true);
                        }
                ...
                S2.define('wpjsfselect2/core', [
                    ...
                    var Select2 = function ($element, options) {
                        if ($element.data('wpjsfselect2') != null) {
                            $element.data('wpjsfselect2').destroy();
                        }
                        ...
                        $element.addClass('wpjsfselect2-hidden-accessible');
                        $element.attr('aria-hidden', 'true');

                        // Synchronize any monitored attributes
                        this._syncAttributes();

                        $element.data('wpjsfselect2', this);
                    };
                    ...
                    Select2.prototype._registerDomEvents = function () {
                        ...
                        this.$element.on('change.wpjsfselect2', function () {
                    ...
                    Select2.prototype._registerEvents = function () {
                        ...
                        this.on('open', function () {
                            self.$container.addClass('wpjsfselect2-container--open');
                        });

                        this.on('close', function () {
                            self.$container.removeClass('wpjsfselect2-container--open');
                        });

                        this.on('enable', function () {
                            self.$container.removeClass('wpjsfselect2-container--disabled');
                        });

                        this.on('disable', function () {
                            self.$container.addClass('wpjsfselect2-container--disabled');
                        });

                        this.on('blur', function () {
                            self.$container.removeClass('wpjsfselect2-container--focus');
                        });
                    ...
                    Select2.prototype.isOpen = function () {
                        return this.$container.hasClass('wpjsfselect2-container--open');
                    };

                    Select2.prototype.hasFocus = function () {
                        return this.$container.hasClass('wpjsfselect2-container--focus');
                    };
                    ...
                    Select2.prototype.focus = function (data) {
                        ...
                        this.$container.addClass('wpjsfselect2-container--focus');
                        this.trigger('focus', {});
                    };
                    ...
                    Select2.prototype.enable = function (args) {
                        if (this.options.get('debug') && window.console && console.warn) {
                            console.warn(
                                'Select2: The `wpjsfselect2("enable")` method has been deprecated and will' +
                    ...
                    Select2.prototype.data = function () {
                        if (this.options.get('debug') &&
                            ...
                            console.warn(
                                'Select2: Data can no longer be set using `wpjsfselect2("data")`. You ' +
                    ...
                    Select2.prototype.val = function (args) {
                        if (this.options.get('debug') && window.console && console.warn) {
                            console.warn(
                                'Select2: The `wpjsfselect2("val")` method has been deprecated and will be' +
                    ...
                    Select2.prototype.destroy = function () {
                        ...
                        this.$element.off('.wpjsfselect2');
                        this.$element.attr('tabindex', this.$element.data('old-tabindex'));

                        this.$element.removeClass('wpjsfselect2-hidden-accessible');
                        this.$element.attr('aria-hidden', 'false');
                        this.$element.removeData('wpjsfselect2');
                    ...
                    Select2.prototype.render = function () {
                        var $container = $(
                            '<span class="wpjsfselect2 wpjsfselect2-container">' +
                        ...
                        this.$container.addClass('wpjsfselect2-container--' + this.options.get('theme'));
                ...
                S2.define('wpjsfselect2/compat/utils', [
                    'jquery'
                ], function ($) {
                    function syncCssClasses($dest, $src, adapter) {
                        ...
                        if (classes) {
                            ...
                            $(classes.split(/\s+/)).each(function () {
                                ...
                                if (this.indexOf('wpjsfselect2-') === 0) {
                ...
                S2.define('wpjsfselect2/compat/containerCss', [
                    'jquery',
                    './utils'
                ...
                S2.define('wpjsfselect2/compat/dropdownCss', [
                    'jquery',
                    './utils'
                ], function ($, CompatUtils) {
                    // No-op CSS adapter that discards all classes by default
                ...
                S2.define('wpjsfselect2/compat/initSelection', [
                    'jquery'
                ], function ($) {
                ...
                S2.define('wpjsfselect2/compat/inputData', [
                    'jquery'
                ], function ($) {
                ...
                S2.define('wpjsfselect2/compat/matcher', [
                    'jquery'
                ], function ($) {
                ...
                S2.define('wpjsfselect2/compat/query', [], function () {
                ...
                S2.define('wpjsfselect2/dropdown/attachContainer', [], function () {
                    ...
                    AttachContainer.prototype.position =
                        function (decorated, $dropdown, $container) {
                            ...
                            $dropdown.addClass('wpjsfselect2-dropdown--below');
                            $container.addClass('wpjsfselect2-container--below');
                        };

                    return AttachContainer;
                });

                S2.define('wpjsfselect2/dropdown/stopPropagation', [], function () {
                ...
                S2.define('wpjsfselect2/selection/stopPropagation', [], function () {
                    function StopPropagation() {
                    }
             ...
             */
                ...
                S2.define('jquery.wpjsfselect2', [
                    'jquery',
                    'jquery-mousewheel',

                    './wpjsfselect2/core',
                    './wpjsfselect2/defaults'
                ], function ($, _, Select2, Defaults) {
                    if ($.fn.wpjsfselect2 == null) {
                        // All methods that should return the element
                        var thisMethods = ['open', 'close', 'destroy'];

                        $.fn.wpjsfselect2 = function (options) {
                            options = options || {};
                            ...
                            if (typeof options === 'object') {
                                ...
                                this.each(function () {
                                    var instance = $(this).data('wpjsfselect2');

                                    if (instance == null && window.console && console.error) {
                                        console.error(
                                            'The wpjsfselect2(\'' + options + '\') method was called on an ' +
                    ...
                    if ($.fn.wpjsfselect2.defaults == null) {
                        $.fn.wpjsfselect2.defaults = Defaults;
                    }
    ...
    var wpjsfselect2 = S2.require('jquery.wpjsfselect2');

    // Hold the AMD module references on the jQuery function that was just loaded
    // This allows Select2 to use the internal loader outside of this file, such
    // as in the language files.
    jQuery.fn.wpjsfselect2.amd = S2;
...
(function ($) {
    ...
    // Import this module.
    window.WPJSFSP = window.WPJSFSP || {};
    window.WPJSFSP.utils = utils;

    $.fn.wpjsfspSerializeForm = utils.serializeForm;
}(jQuery));
/*
 * @copyright   Copyright (c) 2017, Code Atlantic
 * @author      Daniel Iser
